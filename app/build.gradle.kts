...
android {
    ...
    buildTypes {
        ...
        release {
            ...
            buildConfigField("Boolean", "USE_FAKES", "false")
            // Read from local.properties: claude.api.key=sk-ant-...
            val localProps = rootProject.file("local.properties")
            val apiKey = if (localProps.exists()) {
                localProps.readLines()
                    .firstOrNull { it.startsWith("claude.api.key=") }
                    ?.substringAfter("=")?.trim()
                    ?: ""
            } else ""
